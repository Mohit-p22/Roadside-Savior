    ...
    <header>
        <nav class="flex" style="justify-content: space-around;">
            ...
            <ul class="flex" style="width: 100%;">
                ...
                <li><a class="move" onclick="toggleSection('section2')">Mechanic List</a></li>
                ...
                <li><a class="move" onclick="toggleSection('section3')">History</a></li>
            </ul>
            </div>
        ...
        <section id="section2" class="sec " style="display: none;">
              ...
              <tbody>
                <?php
                  ...
                  while($row=$result->fetch_assoc()){
                    echo "
                        ...
                        <a class='btn' href='javascript:toggle()'>Request</a>
                                </td>
                        </tr>";}
                ?>
              </tbody>
                ...
                <div id="popup" class="form-container" >
                            ...
                            <form id="vehicle-form" action="connection/request_form.php" method="post">
                                <h3>Provide Real-Time Details</h3>
                                <label for="driver-name">Vehicle Driver Name:</label>
                                <input type="text" id="driver-name" name="name" placeholder="Diver Name" required>
                                ...
                                <label for="assistance-location">Assistance Needed At:</label>
                                <div class="address">
                                <input type="text" id="line1" name="line1" placeholder="Address line 1" required>
                                ...
                                <label for="vehicle-info">Vehicle Info:</label>
                                <textarea id="vehicle-info" name="vehicleInfo" placeholder="Provide information about vehcile" required></textarea>
                                
                                <label for="service-type">Type of Service Requested:</label>
                                <select id="service-type" name="serviceType" required>
                                    <option value="" disabled selected>Select Service Type</option>
                                    <option value="engine">Problem with Engine</option>
                                ...
                                <label for="situation">Explain Situation:</label>
                                <textarea id="situation" name="situation" placeholder="Explain what is happening" required></textarea>

                                <label for="service-type">Type of Service Requested:</label>
                                <select id="payemnt-mode" name="payment" required>
                                    <option value="" disabled selected>Select Payment Mode</option>
                                    <option value="online">Online</option>
                                    <option value="COD">Cash at onsite</option>
                                </select>
                                
                                <input type="submit" value="Submit" style="background-color: #828bc4;">
                            </form>
                       
                        <a href="#" id="close" style="background-color: #828bc4;" onclick="toggle()">Close</a>
                  </div>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "
                            <tr>
                                ...
                                <td>$row[payment]</td>
                                <td>
                                    <a class='btn' href='remove.php?id=$row[req_id]'>Remove</a>
                                    </td>
                                </tr>";
                        }
                        ?>
